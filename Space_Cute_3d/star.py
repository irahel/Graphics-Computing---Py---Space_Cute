...
class Star:
    ...
    def draw(self):
        ...
        glVertex3f(self.move_x + 0 * self.scale ,self.move_y + 0 * self.scale ,-5)
        glVertex3f(self.move_x + 0 * self.scale, self.move_y + 2 * self.scale,-5)
        glVertex3f(self.move_x + 1.5 * self.scale, self.move_y + 1.5 * self.scale, -5)
        glVertex3f(self.move_x + 2 * self.scale, self.move_y + 0 * self.scale, -5)
        glVertex3f(self.move_x + 1.5 * self.scale, self.move_y + -1.5 * self.scale, -5)
        glVertex3f(self.move_x + 0 * self.scale, self.move_y -2 * self.scale, -5)
        glVertex3f(self.move_x -1.5 * self.scale, self.move_y-1.5 * self.scale, -5)
        glVertex3f(self.move_x -2 * self.scale, self.move_y + 0 * self.scale, -5)
