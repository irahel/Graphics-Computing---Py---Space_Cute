...
class Enemy():
    ...
    def __init__(self, initial_position_x = 0, nave_azul = None, nave_preta = None, nave_amarela = None):
        self.dead = False
        self.move_x = 0
        self.move_y = 70
    ...
    def rand_behavior(self):
        ...
        if choice <= 30:
            ...
            return "Vertical"
        elif choice >= 61 and choice <= 91:
            return "ZigZag"

    # Carrega os valores do objeto
    def load(self,initial_position_x , nave_azul, nave_amarela, nave_preta):
        self.dead = False
        self.move_x = 0
        self.move_y = 70
        self.position_x = initial_position_x
