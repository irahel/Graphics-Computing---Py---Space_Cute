...
class Shoot:
    ...
    def __init__(self, image=None,  position_x_nave=None, position_y_1_nave=None , position_y_2_nave=None, type=None, type_enemy=None):
        self.move = 0
        self.dead = False
    ...
    def draw(self):
        ...
        glBegin(GL_QUADS)
        glTexCoord2f(0, 1)
        glVertex3f(self.start_position_x -0.66,
                   self.move + self.start_position_y_2 + 9, 0)
        glTexCoord2f(1, 1)
        glVertex3f(self.start_position_x +0.66,
                   self.move + self.start_position_y_2 + 9, 0)
        glTexCoord2f(1, 0)
        ...
        glVertex3f(self.start_position_x +0.66,
                   self.move + self.start_position_y, 0)
        glTexCoord2f(0, 0)
        glVertex3f(self.start_position_x -0.66,
                   self.move + self.start_position_y, 0)
        glEnd()
    ...
    def get_x(self):
        return (self.start_position_x -0.66, self.start_position_x +0.66)
    ...
    def load(self,image, position_x_nave , position_y_1_nave, position_y_2_nave, type, type_enemy):
        self.move = 0
        self.dead = False
        self.start_position_x = position_x_nave
        self.start_position_y = position_y_1_nave
