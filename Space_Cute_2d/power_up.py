...
class Power_up():
    ...
    def __init__(self, position_x_nave=None, position_y=None, vida=None, tiro=None, velo=None):
        self.move_y = 0
        self.dead = False
        self.start_position_x = position_x_nave
        self.start_position_y = position_y
        self.start_position_y_2 = position_y
    ...
    def draw(self):
        ...
        if self.skin == 0:
            glBindTexture(GL_TEXTURE_2D, self.skin_vida)
        elif self.skin == 1:
            glBindTexture(GL_TEXTURE_2D, self.skin_tiro)
        elif self.skin ==2:
            glBindTexture(GL_TEXTURE_2D, self.skin_velo)

        glPushMatrix()

        glBegin(GL_QUADS)
        glTexCoord2f(0, 1)
        glVertex3f(self.start_position_x - 2,
    ...
    def get_x(self):
        return (self.start_position_x - 2, self.start_position_x + 2)

    def get_y(self):
        return ( self.move_y + self.start_position_y,  self.move_y + self.start_position_y_2)

    # Carrega as variaveis
    def load(self,position_x_nave, position_y, vida, tiro, velo):
        self.move_y = 0
        self.dead = False
        self.start_position_x = position_x_nave
        self.start_position_y = position_y
        self.start_position_y_2 = position_y + 6
        self.skin_vida = vida
        self.skin_tiro = tiro
        self.skin_velo = velo
